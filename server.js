...
var articles = {
    'article-one' : {
        titles : 'Article One | Mitanshu Khurana',
        heading : 'Article One',
        date : 'Feb 26, 2018',
        content : `<p>
    ...
    'article-two' : {
        titles : 'Article Two | Mitanshu Khurana',
        heading : 'Article Two',
        date : 'Feb 27, 2018',
        content : `<p>
...
`
    ...
    'article-three' : {
        titles : 'Article Three | Mitanshu Khurana',
...
var names = [];
app.get('/submit-name/', function(req, res) { //Using a query parameter...../submit-name?name=xxxxx
   //Get the namw from the request
